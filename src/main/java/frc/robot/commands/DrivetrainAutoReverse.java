 ...
 */
public class DrivetrainAutoReverse extends CommandBase {
  // The subsystem the command runs on
  private  Drivetrain driveTrain;
  private boolean complete = false;
  private double driveDist = Constants.kAutoDistance;

  public DrivetrainAutoReverse(Drivetrain subsystem, double distance) {
  ...
  public void execute() {
    complete =  driveTrain.specificDriveReverse(driveDist);
  }
